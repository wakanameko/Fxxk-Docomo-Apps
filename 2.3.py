...
APPSID = [  # 対象アプリケーションID (e.g. com.example.myapp) のリスト
    ...
    "com.nttdocomo.android.local.guide02",
    "com.nttdocomo.android.store.appssha2",
]
APPSID_SAIFU = [
    "com.nttdocomo.android.felicaremotelock",    # 以下felica, おサイフケータイ系
...
def running(option):
    ...
    if option == (("uninstall") or ("disable")):
        osaifuProtect = messagebox.askyesno('確認','おサイフケータイ機能を残しますか？')
    elif option == (("install") or ("enable")):
